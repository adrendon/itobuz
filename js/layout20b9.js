...
{	
  ...
  $(".no-csstransforms .portfolioContainer .project-details").css('backgroundColor', col);
	...
	$("#connect-with-us .hgroup span").css('borderBottomColor', col);
	$(".screen .hgroup span").css('borderBottomColor', col);
	...
	$("#post-blogs a.red-btn").css('backgroundColor', col);
	$("#post-blogs a.red-btn").css('borderColor', col);
	$('#post-blogs a.red-btn').hover( function(){
		$(this).css('color', col);
	},
	function(){
		$(this).css('color', '#fff');
