$(document).ready(function(){
   ...
   $(window).bind('scroll', function() {
	...
	$('#post-blogs figure').mouseleave(function () {
		...
		/*	FITTEXT
		/*----------------------------------------------------*/
		jQuery("section .hgroup h2").fitText(1.3, {minFontSize: '30px', maxFontSize: '50px'});
		jQuery("section .hgroup h3").fitText(1.8, {minFontSize: '22px', maxFontSize: '30px'});
	...
	if ($(window).width() >= 992) {  
		...
		$('#works').waypoint(function() {
	 	...
	 	$('#post-blogs').waypoint(function() {
			setTimeout(function(){$('#post-blogs article').addClass('animated fadeInLeft')},100);
		}, { offset: '55%' });
    ...
    $(window).on("load resize", function(){
		$(".ipadContainer").height($(".ipadContainer img").height());
	});
});
